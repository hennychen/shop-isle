...
jQuery(window).load(function(){
	...
	jQuery('.post-type-archive-product .products li, .tax-product_cat .products li, .related.products .products li, #shop-isle-blog-container .products li').each(function(){
